  ...
  >
    ...
    <ul className="list-none space-y-4 text-lg text-gray-700 dark:text-gray-200">
      ...
      >
        ...
        <span>Email: <a href="mailto:mbe@mbingsdk.my.id" className="text-blue-500 hover:underline">mbe@mbingsdk.my.id</a></span>
      </motion.li>
      <motion.li
        variants={fadeIn('left')}
        initial="hidden"
      ...
      >
        ...
        <span>Website: <a href="https://mbingsdk.my.id" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">mbingsdk.my.id</a></span>
      </motion.li>
    </ul>
  </motion.div>
);
